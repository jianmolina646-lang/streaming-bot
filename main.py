...
def build_application() -> Application:
    ...
    app.add_handler(CommandHandler("buscarcuenta", admin_h.cmd_buscar_cuenta))
    app.add_handler(CommandHandler("cuentas", admin_h.cmd_cuentas_cliente))
    app.add_handler(CommandHandler("cancelarpedido", admin_h.cmd_cancelar_pedido))
    ...
    app.add_handler(CallbackQueryHandler(admin_h.cb_admin_cancel_or_replace, pattern=r"^adm:(cancel|replace):\d+$"))
