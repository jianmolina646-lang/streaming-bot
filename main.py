...
def build_application() -> Application:
    ...
    app.add_handler(CommandHandler("agentstatus", admin_h.cmd_agent_status))
    app.add_handler(CommandHandler("tagagent", admin_h.cmd_tag_agent_stock))
    app.add_handler(CommandHandler("agentqueue", admin_h.cmd_agent_queue))
